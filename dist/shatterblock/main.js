...
var AdmindashbordComponent = /** @class */ (function () {
    function AdmindashbordComponent(router, route, apiservice) {
        ...
        this.pendingapplication_view_detail_skip = ['_id', 'email', 'name', 'type', 'status'];
...
var ModeldashboardComponent = /** @class */ (function () {
    function ModeldashboardComponent(router, route, apiservice, _sanitizer) {
        this.router = router;
        this.route = route;
        this.apiservice = apiservice;
    ...
    ModeldashboardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__["DomSanitizer"]])
    ], ModeldashboardComponent);
