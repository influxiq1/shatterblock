(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/collections'), require('rxjs/operators'), require('@angular/common/http'), require('moment'), require('@angular/platform-browser'), require('@angular/cdk/a11y'), require('@angular/cdk/drag-drop'), require('@angular/cdk/portal'), require('@angular/cdk/scrolling'), require('@angular/cdk/stepper'), require('@angular/cdk/table'), require('@angular/cdk/tree'), require('@angular/core'), require('@angular/material'), require('@angular/platform-browser/animations'), require('@angular/forms'), require('@angular/common'), require('angular-material-fileupload'), require('ngx-uploader'), require('@angular/router'), require('ngx-moment')) :
    typeof define === 'function' && define.amd ? define('listing-angular7', ['exports', '@angular/cdk/collections', 'rxjs/operators', '@angular/common/http', 'moment', '@angular/platform-browser', '@angular/cdk/a11y', '@angular/cdk/drag-drop', '@angular/cdk/portal', '@angular/cdk/scrolling', '@angular/cdk/stepper', '@angular/cdk/table', '@angular/cdk/tree', '@angular/core', '@angular/material', '@angular/platform-browser/animations', '@angular/forms', '@angular/common', 'angular-material-fileupload', 'ngx-uploader', '@angular/router', 'ngx-moment'], factory) :
    (factory((global['listing-angular7'] = {}),global.ng.cdk.collections,global.rxjs.operators,global.ng.common.http,global.momentImported,global.ng.platformBrowser,global.ng.cdk.a11y,global.ng.cdk['drag-drop'],global.ng.cdk.portal,global.ng.cdk.scrolling,global.ng.cdk.stepper,global.ng.cdk.table,global.ng.cdk.tree,global.ng.core,global.ng.material,global.ng.platformBrowser.animations,global.ng.forms,global.ng.common,global.angularMaterialFileupload,global.ngxUploader,global.ng.router,global.ngxMoment));
}(this, (function (exports,collections,operators,http,momentImported,platformBrowser,a11y,dragDrop,portal,scrolling,stepper,table,tree,i0,material,animations,forms,common,angularMaterialFileupload,ngxUploader,router,ngxMoment) { 'use strict';
    ...
    var ListingComponent = /** @class */ (function () {
        // myForm:any;
        function ListingComponent(_apiService, dialog, bottomSheet, fb, router$$1, resolver, container, _http) {
            var _this = this;
