...
}(this, (function (exports,collections,ngxUploader,ngxCookieService,operators,http,momentImported,rxjs,snackBar,a11y,dragDrop,portal,scrolling,stepper,table,tree,material,animations,forms,common,ngxMoment,router,i0,platformBrowser,ng2Ckeditor) { 'use strict';
                ...
                if (field.dependent != null && field.dependent.length > 0) {
                    ...
                    for (var n in field.dependent) {
                        if (field.dependent[n].condval == this.formGroup.controls[field.name].value) {
                            ...
                            vc++;
                            for (var v in field.dependent[n].field.validations) {
                                // setTimeout( ()=>{
                                ...
                                if (field.dependent[n].field.validations[v].rule == 'pattern')
                                    temvalidationrulet.push(forms.Validators.pattern(field.dependent[n].field.validations[v].value));
                                if (field.dependent[n].field.validations[v].rule == 'maxLength')
                                    temvalidationrulet.push(forms.Validators.maxLength(field.dependent[n].field.validations[v].value));
                                if (field.dependent[n].field.validations[v].rule == 'min')
                                    temvalidationrulet.push(forms.Validators.min(field.dependent[n].field.validations[v].value));
                                if (field.dependent[n].field.validations[v].rule == 'max')
                                    temvalidationrulet.push(forms.Validators.max(field.dependent[n].field.validations[v].value));
                                if (field.dependent[n].field.validations[v].rule == 'minLength')
                                    temvalidationrulet.push(forms.Validators.minLength(field.dependent[n].field.validations[v].value));
                                //},0);
                            }
                            this.formGroup.addControl(field.dependent[n].field.name, new forms.FormControl(field.dependent[n].field.value, temvalidationrulet));
